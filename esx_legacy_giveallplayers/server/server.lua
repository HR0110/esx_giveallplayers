...
ESX.RegisterCommand('giveallitem', 'admin', function(xPlayer, args, showError)
	...
	local count   = (args.amount == nil and 1 or tonumber(args.amount))
...
ESX.RegisterCommand('giveallweapon', 'admin', function(xPlayer, args, showError)
	local _source = source
	local weaponName = string.upper(args.weapon)
	local amount = (args.ammo == nil and 1 or tonumber(args.ammo))
